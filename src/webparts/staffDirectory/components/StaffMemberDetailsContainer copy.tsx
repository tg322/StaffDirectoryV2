...
//     const[cardLeftOffset, setCardLeftOffset] = useState<string>('0');
//     const[cardTopOffset, setCardTopOffset] = useState<string>('100%');
...
//                 const overflowTop = containerRect.bottom - detailsCardRect.bottom;
//                 if(overflowLeft < 360){
//                     const leftVal = 360 - overflowLeft;
//                     setCardLeftOffset(`-${leftVal}px`)
//                 }
//                 if(overflowTop < 200){
//                     const topVal = `calc(-200%)`;
//                     console.log(topVal);
//                     setCardTopOffset(topVal);
//                 }
...
//             </div>
//             {showToolTip && <StaffMemberDetailsToolTip ref={cardRef} user={user} left={cardLeftOffset} top={cardTopOffset}/>}
//         </div>
//     );
// }
